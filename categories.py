...
class Categories():
    ...
    def __init__(self, window):
        ...
        self.back_img = Image.open('images/category_in1.png')
        ...
        self.background_label.place(x=300, y=-250, relwidth=1, relheight=1)
    ...
    def add_Category(self):
        """This function is used to add a new Category into the Categories table of our Grocery Store Management system"""
        ...
        if self.val1 == '' or self.val2 == '' or self.val3 == '':
            ...
            query_loc = "INSERT INTO Categories(categoryID, name, description) values(%s, %s, %s) "
    ...
    def searchNow(self):
        ...
        if selected == "Category ID":
            sql_query = "SELECT * FROM Categories WHERE categoryID=%s"
        elif selected == "Category Name":
            sql_query = "SELECT * FROM Categories WHERE name=%s"
    ...
    def editNow(self):
        ...
        try:
            if self.item_text:
                self.lCategory_Id = Label(self.search_Category, text="Category ID", font=('arial 10 bold'), fg='black')
                ...
                self.lProduct_No = Label(self.search_Category, text="Product Number", font=('arial 10 bold'), fg='black')
    ...
    def updateNow(self):
        ...
        update_query = "UPDATE Categories SET categoryID = %s, name= %s WHERE Product_No = %s"
